...
<html class="no-js" lang="">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Money Tracking</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?php echo APP_URL; ?>/accounts">Cuentas<span class="sr-only">(current)</span></a></li>
        <li><a href="<?php echo APP_URL; ?>/users">Usuarios<span class="sr-only">(current)</span></a></li>
        <li><a href="<?php echo APP_URL; ?>/types">Tipos de Usuario<span class="sr-only">(current)</span></a></li>
        <li><a href="<?php echo APP_URL; ?>/transactions">Transacciones<span class="sr-only">(current)</span></a></li>
